...
DynamicReadOnlyCharacteristic.prototype.onReadRequest = function(
    offset,
    callback
) {
...
LongDynamicReadOnlyCharacteristic.prototype.onReadRequest = function(
    offset,
    callback
) {
    var result = this.RESULT_SUCCESS;
...
NotifyOnlyCharacteristic.prototype.onSubscribe = function(
    ...
    this.changeInterval = setInterval(
        function() {
            ...
            console.log(
                'NotifyOnlyCharacteristic update value: ' + this.counter
            );
...
IndicateOnlyCharacteristic.prototype.onSubscribe = function(
    maxValueSize,
    updateValueCallback
) {
    ...
    this.changeInterval = setInterval(
        function() {
            ...
            console.log(
                'IndicateOnlyCharacteristic update value: ' + this.counter
            );
            updateValueCallback(data);
            this.counter++;
        }.bind(this),
